        ...
        {trilho ? (
          ...
          <div className="trilhos-abertura">
            ...
            <p className="trilhos-lede">
              {TRILHOS.length} percursos a pé na Região de Coimbra, {concelhos === 19 ? 'nos 19 concelhos' : `em ${concelhos} dos 19 concelhos`}: {fmt(TOTAL_KM)} quilómetros de caminho — das
