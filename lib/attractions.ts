...
export const ATTRACTIONS: Attraction[] = [
  ...
  },
  {
    ...
    area: 'alta',
    blurb:
      'Catedral românica a meio da subida para a Alta, construída quando Coimbra era capital do reino. Por fora parece uma fortaleza — e era mesmo essa a ideia.',
